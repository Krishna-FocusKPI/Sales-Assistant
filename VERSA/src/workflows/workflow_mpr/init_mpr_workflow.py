"""
MPR workflow bootstrap. Sets session state for the LangGraph path (no legacy graph).
"""
...
def init_mpr_workflow():
    st.session_state.workflow["name"] = WorkFlows.WORKFLOW_MPR.value
