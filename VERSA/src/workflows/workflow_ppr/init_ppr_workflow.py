"""
PPR workflow bootstrap. Sets session state for the LangGraph path (no legacy graph).
"""
...
def init_ppr_workflow():
    st.session_state.workflow["name"] = WorkFlows.WORKFLOW_PPR.value
